...
;(function($) {
	...
	MobileNavigation.prototype = {
		...
		showLevel: function(listItem, titleText) {
			...
			this.wrapper.stop().animate({height: dropHeight}, this.options.animSpeed);
		},
		hideLevel: function(listItem) {
			...
			if (self.levelCounter === 0){
				...
				this.wrapper.stop().animate({height: self.slider.innerHeight()}, this.options.animSpeed);
			...
			this.moveSlider({
				complete: function() {
					...
					if (self.levelCounter !== 0){
						...
						self.wrapper.stop().animate({height: parentListItemDropHeight}, self.options.animSpeed);
					}
				}
			});
